        ...
        <nav className="flex gap-4">
          {TABS.map((t) => (
            <button
              ...
              className={`border-b-2 py-3 text-base font-medium ${activeTab === t.id ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
            >
              {t.label}
            </button>
          ))}
      ...
      <div className="card-body">
        {activeTab === 'general' && (
          <div className="space-y-4">
            <div>
              <label htmlFor="config-platform-name" className="block text-base font-medium text-slate-700">Platform name</label>
            ...
            <div>
              <label htmlFor="config-contact-email" className="block text-base font-medium text-slate-700">Contact email</label>
        ...
        {activeTab === 'session' && (
          <div className="space-y-4">
            <div>
              <label htmlFor="config-inactivity-timeout" className="block text-base font-medium text-slate-700">Inactivity timeout (minutes)</label>
            ...
            <label htmlFor="config-mfa-required" className="flex items-center gap-2">
              ...
              <span className="text-base font-medium text-slate-700">MFA required</span>
            </label>
          </div>
        )}
        {activeTab === 'notifications' && (
          <div className="space-y-4">
            <div>
              <label htmlFor="config-smtp-host" className="block text-base font-medium text-slate-700">SMTP host</label>
            ...
            <div>
              <label htmlFor="config-default-digest" className="block text-base font-medium text-slate-700">Default digest</label>
        ...
        {activeTab === 'storage' && (
          <div className="space-y-4">
            <div>
              <label htmlFor="config-minio-quota" className="block text-base font-medium text-slate-700">MinIO quota (GB)</label>
            ...
            <div>
              <label htmlFor="config-retention-days" className="block text-base font-medium text-slate-700">Retention (days)</label>
        ...
        {activeTab === 'workflow' && (
          <div className="space-y-4">
            <div>
              <label htmlFor="config-approval-deadline" className="block text-base font-medium text-slate-700">Default approval deadline (hours)</label>
            ...
            <div>
              <label htmlFor="config-escalation-grace" className="block text-base font-medium text-slate-700">Escalation grace period (hours)</label>
        ...
        {activeTab === 'security' && (
          <div className="space-y-4">
            <div>
              <label htmlFor="config-password-min-length" className="block text-base font-medium text-slate-700">Password min length</label>
            ...
            <div>
              <label htmlFor="config-allowed-ip-ranges" className="block text-base font-medium text-slate-700">Allowed IP ranges (optional)</label>
        ...
        {error && <p className="mt-4 text-base text-red-600" role="alert">{error}</p>}
        {saved && <p className="mt-4 text-base text-emerald-600">Settings saved. Changes are logged to the audit trail.</p>}
