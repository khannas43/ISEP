      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <Link href="/dashboard" className="card flex flex-col overflow-hidden transition-shadow hover:shadow-md">
          <div className="card-body flex-1">
            ...
            <p className="mt-1 text-sm text-slate-600">User-specific overview and quick stats</p>
          </div>
          <div className="border-t border-slate-100 bg-slate-50/50 px-6 py-3">
            <span className="text-sm font-medium text-blue-600">Open dashboard →</span>
          </div>
        </Link>
        <Link href="/meetings" className="card flex flex-col overflow-hidden transition-shadow hover:shadow-md">
          <div className="card-body flex-1">
            <h2 className="text-sm font-medium text-slate-500">Meetings</h2>
            <p className="mt-2 text-lg font-semibold text-slate-900">Meetings list</p>
            <p className="mt-1 text-sm text-slate-600">Filter and browse all meetings</p>
          </div>
          <div className="border-t border-slate-100 bg-slate-50/50 px-6 py-3">
            <span className="text-sm font-medium text-blue-600">View meetings →</span>
          </div>
        </Link>
        <Link href="/bodies" className="card flex flex-col overflow-hidden transition-shadow hover:shadow-md">
          <div className="card-body flex-1">
            <h2 className="text-sm font-medium text-slate-500">Bodies</h2>
            <p className="mt-2 text-lg font-semibold text-slate-900">International bodies</p>
            <p className="mt-1 text-sm text-slate-600">Committees and hierarchy</p>
          </div>
          <div className="border-t border-slate-100 bg-slate-50/50 px-6 py-3">
            <span className="text-sm font-medium text-blue-600">View bodies →</span>
          </div>
        </Link>
      </div>
